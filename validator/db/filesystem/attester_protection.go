...
func (s *Store) SaveAttestationsForPubKey(
	...
	maxIncomingSourceEpoch, maxIncomingTargetEpoch, err := s.newMethod(atts)
	if err != nil {
...
func (*Store) newMethod(atts []*ethpb.IndexedAttestation) (primitives.Epoch, primitives.Epoch, error) {
